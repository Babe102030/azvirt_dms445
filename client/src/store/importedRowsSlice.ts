...
const importedRowsSlice = createSlice({
  ...
  reducers: {
     ...
     */
    setRows(state, action: PayloadAction<{ rows: Row[]; fileName?: string }>) {
     ...
     */
    appendRows(state, action: PayloadAction<Row[]>) {
...
export const selectImportedFileName = (state: { importedRows: ImportedState }) =>
