export const az = {
  ...
  nav: {
    ...
    shiftManagement: "Növbə İdarəetməsi",
    reports: "Hesabatlar",
  ...
  // Shift Management
  shiftManagement: {
    title: "Növbə İdarəetməsi",
    description: "İşçi növbələrini, şablonlarını və cədvəllərini idarə edin",
    assignShift: "Növbə Təyin Et",
    createTemplate: "Şablon Yarat",
    shiftTemplates: "Növbə Şablonları",
    employeeAvailability: "İşçi Mövcudluğu",
    shiftSwaps: "Növbə Dəyişdirmələri",
    startTime: "Başlama Vaxtı",
    endTime: "Bitiş Vaxtı",
    duration: "Müddət",
    color: "Rəng",
    isActive: "Aktiv",
    shiftDate: "Növbə Tarixi",
    noShifts: "Planlaşdırılmış növbə yoxdur",
    conflictDetected: "Növbə münaqişəsi aşkar edildi",
    swapRequested: "Dəyişdirmə Sorğusu Göndərildi",
    approveSwap: "Dəyişdirməni Təsdiqlə",
    rejectSwap: "Dəyişdirməni Rədd Et",
    breakStartTime: "Fasilə Başlanğıcı",
    breakEndTime: "Fasilə Bitişi",
    complianceAudit: "Uyğunluq Auditi",
  },
